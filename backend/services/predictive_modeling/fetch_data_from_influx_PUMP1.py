...
def query_influxdb():
    ...
    try:
        ...
        from(bucket: "{BUCKET}")
            ...
            |> filter(fn: (r) => r["_measurement"] == "I_p1" or r["_measurement"] == "PUMP1/Press_P1_VB_OUT" or r["_measurement"] == "PUMP1/Temp_P1_B1_VB_OUT" or r["_measurement"] == "PUMP1/Temp_P1_B2_VB_OUT" or r["_measurement"] == "PUMP1/Temp_P1_m1_VB_OUT" or r["_measurement"] == "PUMP1/Temp_P1_m2_VB_OUT" or r["_measurement"] == "PUMP1/Temp_P1_m3_VB_OUT")
        '''
        ...
        #with open('fetched_data_p1.txt','w',encoding='utf-8') as f:
