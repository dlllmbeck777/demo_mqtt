...
const defaultApiBaseUrl = "http://192.168.1.88:8000";
...
export const influxUrl =
    process.env.REACT_APP_INFLUX_URL || "http://192.168.1.88:8086";
export const backfillBucket =
    process.env.REACT_APP_INFLUX_BACKFILL_BUCKET || "horasan_backfill";
export const backfillAlarmBucket =
    process.env.REACT_APP_INFLUX_BACKFILL_ALARM_BUCKET || "inkai_backfill_alarms";
export const backfillLogsBucket =
    process.env.REACT_APP_INFLUX_BACKFILL_LOGS_BUCKET || "inkai_backfill_logs";
...
export const liveBucket =
    process.env.REACT_APP_INFLUX_LIVE_BUCKET || "horasan_live";
