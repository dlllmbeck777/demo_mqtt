...
def process_data(data1):
    ...
    for i in range(len(data)):
        if data[i]["tag_name"]=="PUMP2/Temp_P2_B1_VB_OUT" and data[i]["combined_prediction"]>40 :
            data[i]["sendtofront"]="yes"
        elif data[i]["tag_name"]=="PUMP2/Temp_P2_B1_VB_OUT" and data[i]["combined_prediction"]<=40 :
