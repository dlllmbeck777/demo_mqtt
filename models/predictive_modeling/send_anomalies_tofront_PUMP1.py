...
def process_data(data1):
    ...
    for i in range(len(data)):
        if data[i]["tag_name"]=="PUMP1/Temp_P1_B1_VB_OUT" and data[i]["combined_prediction"]>40 :
            data[i]["sendtofront"]="yes"
        elif data[i]["tag_name"]=="PUMP1/Temp_P1_B1_VB_OUT" and data[i]["combined_prediction"]<=40 :
