...
def query_influxdb():
    ...
    try:
        ...
        from(bucket: "{BUCKET}")
            ...
            |> filter(fn: (r) => r["_measurement"] == "I_p4" or r["_measurement"] == "PUMP4/Temp_P4_B1_VB_OUT" or r["_measurement"] == "PUMP4/Temp_P4_B2_VB_OUT" or r["_measurement"] == "PUMP4/Temp_P4_m1_VB_OUT" or r["_measurement"] == "PUMP4/Temp_P4_m2_VB_OUT" or r["_measurement"] == "PUMP4/Temp_P4_m3_VB_OUT")
        '''
